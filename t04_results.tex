...
\begin{figure}[ht]
    \caption{Locations of identified sites in the \emph{Restricted} Slice.
    Specifically identified are two locations of interest.
    \makenote{Change Label to PIA, add packer terminal, make plot 
