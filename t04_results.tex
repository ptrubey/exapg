...
Given the geographical focus inherent in the original data, we focus our primary analysis on 
    Delaware Bay.  Figure~\ref{map:delawarebay} gives the locations of sites we identified, 
    along with a classification of those sites.  
    
    Four categories were considered: ``Services'', that
