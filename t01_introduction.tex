\begin{comment}
    \begin{itemize}
        \item Introduce dataset
        \item Brief discussion of extreme analysis (up to thresholding)
    \end{itemize}
\end{comment}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{\makenote{replace with 90th percentile}
            99th percentile of storm-surge simulations at \num{5283} selected 
...
This paper analyzes SLOSH simulations under an extreme value theory (EVT) framework, 
    ...
    interest.  Displayed are the 99th\makenote{change to 90th} percentile 
