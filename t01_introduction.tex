...
%     \end{minipage}
%     \caption{
%         (Left) Grid output from one storm simulation in SLOSH, with a marginal
%         histogram (with log-scale counts) of surge levels in that storm.  Note
%         the bounds are determined by the data, with the maximum value for this
%         storm is 19 feet above ground level.  
%         (Right) 99th percentile of storm-surge simulations at \num{5283} selected 
%         locations, 
%         with marginal histogram (with log-scale counts) of 99th percentiles at
%         said locations.  The maximum of the 99th percentiles calculated is 10.6
%         feet above ground level.\label{fig:sloshexplore}
%         }
% \end{figure}
