...
Statistical inference of extreme values tends to focus on the \emph{return period} as a 
    ...
    extreme analysis on different summary statistics, assessed over the aggregate spatial field: 
    ...
    \bruno{\bf Do you actually use all this? I think you should just say what we do, which is to 
        consider the conditional joint probabilities, and mention this in passing.}
    \makenote{I'm trying to make the case as to \emph{why} what we're doing is difficult,
        and seldom attempted in practice.  Maybe this paragraph would make more sense 
        as a subsection in background?  But why we're citing \cite{salvadori2010}
        as comparable to our problem (in lower scale) wouldn't make sense until SLOSH
        is introduced.  Very much a bootstraps problem.}
