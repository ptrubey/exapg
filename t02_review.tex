...
\makenote{first paragraph basically copy-pasted from ndpg.  should probably
    rephrase more.}
...
To better capture the variability in the data, we use the projected gamma density 
    as a kernel density for a Pitman--Yor mixture model.
...
\makenote{these 2 paragraphs are intended to introduce the reasoning for varbayes.
    I like the wordsmithing at the end of the second paragraph, but i'm unsure of
    if they're necessary, or the most appropriate}
