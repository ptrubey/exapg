...
The validity of the proposed PoT model depends on asymptotic results that consider 
    ...
    % Figure~\ref{fig:sloshexplore} shows those boundaries over a portion of 
...
\begin{figure}[htb]
    ...
    \caption{Pairwise plot of SLOSH simulation inputs that survived thresholding in the 
        \emph{Threshold} slice.  Sea level rise in mm, approach angle in degrees (360 is North),
        approach speed in Kph, minimum pressure in mBar, latitude in decimal degrees.
        \makenote{
...
Figure~\ref{fig:thetahistogram} shows the marginal histograms of SLOSH input 
    ...
    make it easier for a storm to inundate larger swaths of land, and to a
