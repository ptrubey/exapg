...
\begin{table}[htb]
    ...
    \makenote{quantiles unnecessary... excise?  Rewrite to\}\label{tab:datasets}}
    \include{./tables/datadesc}
\end{table}

We consider the analysis
At this point, we consider the analysis of the SLOSH data in 4 parts.  First, examining
